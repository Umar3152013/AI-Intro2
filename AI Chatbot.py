...
jokes= {
    ...
    "Why did the computer go to the doctor? It has a virus!",
    "Why do travelers always feel warm? All of their hot spots!"
}  

def normalize_input(preference):
...
def recommend():
    ...
    if preference in destanation:
        suggestion = random.choice(destanation[preference])
...
def packing_tips():
    ...
    print(Fore.GREEN + "TravelBot: How many days?")
...
def show_help():
    ...
    print(Fore.GREEN + "-Tell a joke (say a 'joke')")
