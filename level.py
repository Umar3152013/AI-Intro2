    ...
    for event in pygame.event.get():
        ...
        if not won:
            ...
            if sprite1.rect.colliderect(sprite2.rect):
                ...
                won=True
        screen.bilt(background_image, (0,0))
        all_sprites.draw(screen)

        if won:
            win_text = font.remder("You win", True,pygame.Color('black'))
            screen.bilt(win_text, ((SCREEN_WIDTH - win_text.get_width())) // 2, (SCREEN_HEIGHT - win_text.get_height()) // 2)
